	...
	<div class="container-fluid" style="background: white">
		<div class="row">
			<div class="container m-t-40 m-b-40">
				...
				<div class="col-sm-10 col-md-6 col-xs-offset-1">
					<div class="col-xs-12 ft-s-13 ft-w-sb">
						<?php _e('Encontre-nos', 'enova-foods'); ?>
					</div>
					<div class="col-xs-12 col-md-6">
						<h1 class="ft-s-13 ft-w-sb ft-gray"><?php _e('Fábrica', 'enova-foods') ?>, Catanduva</h1>
						<div class="ft-w-r ft-s-13 ft-gray lh21">Avenida Elias Bauab, 665 - Distrito Industrial José Antonio Boso, Catanduva – SP</div>
						<h1 class="ft-s-13 ft-w-sb ft-gray"><?php _e('Fábrica', 'enova-foods') ?>, Queluz</h1>
						<div class="ft-w-r ft-s-13 ft-gray lh21">Rodovia Presidente Dutra, 5,5km - Bairro Estrela, Queluz – SP</div>
					</div>
					<div class="col-xs-12 col-md-6">
						<h1 class="ft-s-13 ft-w-sb ft-gray"><?php _e('Escritório', 'enova-foods') ?>, São Paulo</h1>
						<div class="ft-w-r ft-s-13 ft-gray lh21">Av. Queiroz Filho, 1700 - Conjunto 301- Torre Sky, Villa Hamburguesa, São Paulo – SP</div>
						<h1 class="ft-s-13 ft-w-sb ft-gray"><?php _e('Fábrica', 'enova-foods') ?>, Rio de Janeiro</h1>
						<div class="ft-w-r ft-s-13 ft-gray lh21">Rua Manoel Vitorino, 155 – Bairro Encantado, Rio de Janeiro – RJ</div>
					</div>
				</div>
				<div class="hidden-sm col-md-3 col-xs-offset-1">
